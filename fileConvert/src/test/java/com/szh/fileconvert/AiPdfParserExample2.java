...
/**
 * AiPdfParser使用示例（火山引擎Ark API）- 合同模式
 */
public class AiPdfParserExample2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        context.setContractMode(true); // 设置为合同文档模式
        ...
        if (parser.supports("pdf")) {
            ...
            // 7. 保存到文件
            File outputFile = new File("D:\\JavaExercise\\SLYT\\demo\\fileConvert\\src\\test\\java\\com\\szh\\fileconvert\\contractM2.md");
