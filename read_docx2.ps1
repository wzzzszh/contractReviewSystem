...
if ($targetFile -eq $null) {
    Write-Output "Target file not found by size 27623"
    exit 1
}

$tempPath = 'd:\JavaExercise\SLYT\contractReviewSystem\risk_tips_temp2.docx'
...
$outFile = 'd:\JavaExercise\SLYT\contractReviewSystem\risk_data_2.txt'
